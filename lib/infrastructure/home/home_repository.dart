import 'package:commerce_blue/core/api_endpoints.dart';
...
class HomeRepository implements HomeServices {
  ...
  Future<Either<MainFailure, List<HomeProductModel>>>
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final electronicProductsList = (response.data as List).map((e) {
          return HomeProductModel.fromJson(e);
        }).toList();
  ...
  Future<Either<MainFailure, List<HomeProductModel>>>
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final jeweleryProductsList = (response.data as List).map((e) {
          return HomeProductModel.fromJson(e);
        }).toList();
  ...
  Future<Either<MainFailure, List<HomeProductModel>>>
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final menclothingProductsList = (response.data as List).map((e) {
          return HomeProductModel.fromJson(e);
        }).toList();
  ...
  Future<Either<MainFailure, List<HomeProductModel>>>
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final womenclothingProductsList = (response.data as List).map((e) {
          return HomeProductModel.fromJson(e);
        }).toList();
